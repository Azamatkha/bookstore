            ...
            <div class="glass-panel hero-panel overflow-hidden p-6 lg:p-8">
                ...
                <div class="hero-copy relative z-10">
                    ...
                    <div class="mt-6 flex flex-wrap gap-3">
                        ...
                        <a href="{{ route('cart.index') }}" class="btn-secondary">Open Cart</a>
                    </div>
                </div>
            </div>

            <div class="featured-stack">
                <p class="text-sm font-semibold uppercase tracking-[0.3em] text-slate-400">Featured Books</p>
    ...
    <section id="catalog" class="page-shell pb-16">
        <div class="panel mb-8 p-6">
            <form method="GET" action="{{ route('home') }}#catalog" class="grid gap-4 lg:grid-cols-6">
                ...
                <div class="flex items-end gap-3">
                    ...
                    <a href="{{ route('home') }}#catalog" class="btn-secondary w-full text-center">Reset</a>
                </div>
            </form>
        </div>
        ...
        <div class="mb-6 flex items-center justify-between gap-4">
            <div>
                ...
                <h2 class="mt-1 text-4xl">Available Books</h2>
            </div>
        ...
        @else
            <div class="panel p-10 text-center">
                <h3 class="text-3xl">No books matched your filters.</h3>
